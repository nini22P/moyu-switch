...
感谢萌译汉化组的授权，本汉化补丁基于萌译汉化组的汉化成果制作，并在原文本基础上使用 **Gemini 2.5 Pro** 辅助校对，进行了**大量文本调整和错误修正**，旨在帮助玩家更准确地理解剧情。细心的玩家可能会发现许多不同的地方。

请注意，由于技术原因，**读档、存档等界面尚未完全汉化，可能会出现方框文字等情况**。但这不影响您游戏的正常体验。
...
2.  《樱花，萌放。-as the Night's, Reincarnation-》Nintendo Switch 版本的著作权属于 **FAVORITE / ENTERGRAM**，编辑者与 **FAVORITE / ENTERGRAME** 没有任何联系。
3.  如果发布的文本内容侵犯了您的版权，请联系我们删除。

如果您想要发布衍生的文本，请参照 CC-BY-NC-SA 4.0 协议的要求。此外，请注明修改的内容，如果发布的衍生文本包含 **R18** 内容请删去原编辑者的身份信息。

---

## 注意事项

* 本汉化补丁基于**萌译汉化组**汉化成果制作。
* 本汉化补丁**仅供个人学习交流使用**。
* 本汉化补丁**完全免费！！！**
* 若您通过购买获得请**立即退款并举报**。
* **严禁**将本汉化补丁打包至游戏本体内。
...
本汉化补丁为 mod 形式，不包含游戏本体，请不要将汉化补丁打包进游戏本体内。请支持正版游戏。
