...
感谢萌译汉化组的授权，本次汉化补丁基于萌译汉化组的汉化成果，并在此基础上进行了大量文本调整和错误修正。我们首先利用 Gemini 2.5 Pro 对文本进行了校对，随后再由人工进行修正和润色，旨在帮助玩家更准确地理解剧情，获得更好的游戏体验。
...
在校对过程中，我们发现原始脚本存在一些错误，现已修复并在此列出：

* 小春线后半段有一句台词（大雅くん？）的原始脚本标注为“大雅”所说，但实际应为小春。我们已修正此错误，并将语音替换为其他语句中的相同台词的语音。
* 小黑线有一句台词根据词意判断应为朝日所说，但原始脚本标注为“大雅”。我们已修正此错误，但目前暂无匹配的语音，游玩到这里会出现无语音的情况。
